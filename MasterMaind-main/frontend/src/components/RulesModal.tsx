            ...
            <div className="space-y-6 text-slate-300">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-4 bg-slate-800/50 p-3 rounded-xl border border-slate-700/50">
                        <div className="w-4 h-4 rounded-full bg-slate-100 border-2 border-white shadow-[0_0_5px_rgba(255,255,255,0.5)]"></div>
                        <div>
                    ...
                    <div className="flex items-center gap-4 bg-slate-800/50 p-3 rounded-xl border border-slate-700/50">
                        <div className="w-4 h-4 rounded-full bg-slate-950 border-2 border-slate-800"></div>
                        <div>
